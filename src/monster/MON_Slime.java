...
public class MON_Slime extends entity.Entity {
    ...
    public void getSlimeImage() {
        up1 = setup("/res/monster/slimeup1", gp.tileSize, gp.tileSize);
        up2 = setup("/res/monster/slimeup2", gp.tileSize, gp.tileSize);
        down1 = setup("/res/monster/slimedown1", gp.tileSize, gp.tileSize);
        down2 = setup("/res/monster/slimedown2", gp.tileSize, gp.tileSize);
        left1 = setup("/res/monster/slimeleft1", gp.tileSize, gp.tileSize);
        left2 = setup("/res/monster/slimeleft2", gp.tileSize, gp.tileSize);
        right1 = setup("/res/monster/slimeright1", gp.tileSize, gp.tileSize);
        right2 = setup("/res/monster/slimeright2", gp.tileSize, gp.tileSize);
    }
